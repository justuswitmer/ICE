    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.expectContainer}>
          <div className={styles.headerExpectContainer}></div>
          <div className={styles.expectContainerRotate}>
            <div className={styles.expectDetailContainer}>
              <h2>What can you expect from ICE?</h2>
              <div className={styles.expectDetailContent}>
          ...
          <div className={styles.footerExpectContainer}></div>
        </div>
      </main>
      <Footer />
    </div >
